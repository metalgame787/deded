...
var allchest=[];
var allwalls=[];
var enemigo,enemigo2,enemigoImg,enemigoImg2;
...
enemigoImg=loadImage("ongito1.png");
enemigoImg2=loadImage("ongito2.png");
}
...
function setup(){
  ...
  enemigo=createSprite(1700,height/2,100,100);
  enemigo2=createSprite(1850,height/16,50,50);
enemigo.addImage(enemigoImg);
enemigo2.addImage(enemigoImg2);
enemigo.velocityY=-2;
...
if (allwalls[3].x>-1030){
  for (var xd in allwalls){allwalls[xd].x+=3}
}
if (allchest[3].x>-1030){
  for (var xd in allchest){allchest[xd].x+=3}
}
